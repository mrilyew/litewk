window.consts = {
    ...
    'CSS_FOCUS_NAVIGATION': `.navigation {
        background: var(--header-color);
        outline: 1px solid var(--elements-color-second);
        height: auto;
    }
    ...
    'MASONRY_MARGIN_WIDTH': 4,
    'MASONRY_MARGIN_HEIGHT': 4,
    ...
    'DEFAULT_VK_API_DOMAIN': 'api.vk.com/method',
    'DEFAULT_VK_WEB_DOMAIN': 'vk.com',
    'DEFAULT_VK_API_DOMAIN_FULL': 'https://api.vk.com/method/',
    'VK_DOCS_URL': 'dev.vk.com/ru'
}

window.consts.TYPICAL_USERS_GROUPS_FIELDS = window.consts.TYPICAL_FIELDS + ',' + window.consts.TYPICAL_GROUPS_FIELDS
