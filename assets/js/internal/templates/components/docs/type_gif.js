window.templates.doc_gif_attachment = (doc) => {
    const preview = doc.getPreview()

    return `
    <a href='#doc${doc.getId()}' data-width='${preview.width}' data-height='${preview.height}' data-ignore='1' class='ordinary_attachment gif_attachment doc_attachment doc_attachment_tall' data-url='${doc.getURL()}' data-docid='${doc.getId()}' title='${doc.getTitle()}'>
        ...
        <div id='_vid'>
            <video data-src='${doc.getVideoPreview()}' loop>
        </div>
    </a>
    `
}
