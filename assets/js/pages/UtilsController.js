window.controllers['UtilsController'] = (function() {
    return {
        Away: async function() {
            ...
            if(Boolean(parseInt(text))) {
                ...
                if(!link) {
                    ...
                    if(!res.type) {
                        MessageBox.toggleCircle()
                        window.main_class.addOnpageErrorWithTitle(_('user_page.info'), `
                        ${_('navigation.not_found_shortcode')}
            
                        <div class='away_buttons'>
                            <input type='button' id='__gono' value='${_('messagebox.no')}'>
                            <input type='button' class='primary' id='__goyes' value='${_('messagebox.yes')}'>
                        </div>
                        `)
