...
- Токен может быть украден, например, с помощью XSS-уязвимости, либо с помощью стиллера, либо с помощью незащищённого WiFi.
...
- Ваш аккаунт совсем не будет пробуждаться в онлайн. Но если вам это нужно, в настройках включите опцию "Пробуждать аккаунт в онлайн каждые 5 минут".
...
- [ ] Просмотр ЧС
- [x] Показ счётчиков в пунктах меню
- [x] Не использовать vkhost.github.io
...
- [ ] Смена образования
- [ ] Смена карьеры
- [ ] Смена военной службы
- [ ] Смена жизненной позиции
...
- [ ] Репорт
- [ ] Поддержка "карусели"
- [ ] Отправка события "просмотр поста" (на усмотрение пользователя)
...
- [ ] Поиск по ним (01.06.2024)
- [ ] **Метки**
- [x] Просмотр (01.06.2024)
- [ ] Создание
- [ ] Редактирование
