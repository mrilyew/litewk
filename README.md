...
- [ ] Кнопка "наверх" при определённых обстоятельствах будет кнопкой "Назад"
...
- [ ] Загрузка картинок по мере прокрутки к ним
...
- [ ] Просмотр ЧС
- [ ] Нормальная авторизация (по логину и паролю)
- [ ] Поддержка 2fa нормальной авторизации
- [x] Показ счётчиков в пунктах меню (30.06.2024)
- [x] Не использовать vkhost.github.io (30.06.2024)
- [ ] Локальное редактирование аккаунтов
- [ ] Поддержка отображения того, что твой акк забанили.
...
- [ ] Поддержка отображения блокировки страницы (ркн/заморозка/полная блокировка)
...
- [ ] **Посты**
- [x] Наличие прикреплений
- [x] Тип (обычные, только копии)
- [ ] 
