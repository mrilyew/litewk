...
Первый (после ApiDog ~~(и durov.ru)~~) альтернативный Web-клиент для VK. Написан без использования фреймворков на почти чистом JS, используются библиотеки jQuery, Moment.js Twemoji.js, Lottie (для анимированных стикеров).
...
|Обложка репозитория, помощь в тестировании|Alisher Alexandrov (Discord: `priwetvsem`)|
