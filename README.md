...
- Сайт использует [незадокументированные методы VK API](vkapi), которые могут использовать только официальные приложения. Если, например, при нажатии на графический статус (смайлик после имени) выводится ошибка "Unknown method passed", попробуйте выбрать другое приложение.
...
- [ ] Расставить лоадеры (и мб при загрузке страницы показывать макет без контента)
...
- [ ] Если документ гифовый, то отображать кнопку плюсик.
